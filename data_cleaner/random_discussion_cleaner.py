...
from data_cleaner.discussion_reader import get_all_random_discussions, save_cleaned_random_discussions
...
if __name__ == '__main__':
    ...
    save_cleaned_random_discussions(cleaned_random_discussions)
