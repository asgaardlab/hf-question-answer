## https://huggingface.co/IkariDev/Athena-v3/discussions/2

contains_question: yes

question_part: 
- Should I use the [recommended settings by localfultonextractor](https://files.catbox.moe/ue0tja.json) in v2's description for v3?
