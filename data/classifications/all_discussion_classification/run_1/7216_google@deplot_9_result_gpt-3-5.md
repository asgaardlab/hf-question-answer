## https://huggingface.co/google/deplot/discussions/9

contains_question: yes

question_part: What would be some of the ways to adapt this model to other languages (with non-alphabets)?
