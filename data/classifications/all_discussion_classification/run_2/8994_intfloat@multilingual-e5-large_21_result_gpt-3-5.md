...
question_part: My specific aim is to train an embedding model to return relevant documents chunks given a query or unlabeled sub-topic. I have the following questions:
