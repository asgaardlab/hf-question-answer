...
question_part: Hi, I'm trying to transform the xlm-roberta-xxlarge model from [here](https://github.com/facebookresearch/fairseq/tree/main/examples/xlmr#pre-trained-models), from Pytorch's .pt to Hugging Face's .bin but I'm having a hard time.
