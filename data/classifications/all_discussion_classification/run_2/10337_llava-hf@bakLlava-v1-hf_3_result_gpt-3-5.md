## https://huggingface.co/llava-hf/bakLlava-v1-hf/discussions/3

contains_question: yes

question_part: How do i pass in multiple images to the model
I am trying to build a chat like interface
