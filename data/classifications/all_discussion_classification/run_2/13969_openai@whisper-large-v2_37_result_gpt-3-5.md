## https://huggingface.co/openai/whisper-large-v2/discussions/37
...
Preferably I would be able to use my OpenAI API key for this so the transcription/processing is fast, rather than local processing on my computer.
